        ...
        <figcaption>
          ...
          <div className="row open-sans-font">
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">Sports-Stadium Booking</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">Html, css, javascript, React Js</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">
                <a
                  href="https://sportswander.com/"
                  target="_blank"
                  rel="noreferrer"
                >
                  www.sportswander.com
                </a>
              </span>
            </div>
            {/* End .col */}
